...
class UnicycleDynamics(Dynamics):
    ...
    def step(self, action, dt):
        ...
        #print("X, Y coordinate are:")
        print(self.agent.pos_global_frame)
        ...
        vx = self.agent.vel_global_frame[0]
        vy = self.agent.vel_global_frame[1]
        v_res = np.sqrt(vx**2 + vy**2)
        print(v_res)
        ...
        #print(self.agent.speed_global_frame)
